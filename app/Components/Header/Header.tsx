      ...
      <header className='flex justify-between py-5 items-center w-full'>
        ...
        <div className='flex justify-between'>
          ...
          <div className=''>
                    ...
                    <div className={`flex justify-end items-end flex-col absolute h-auth rounded-xl bg-slate-800 py-2 px-6 top-14 right-11 transition-all duration-300 ease-in-out xxs:right-3 z-20 ${isOpen ? 'top-16 opacity-100' : ' -top-full opacity-0'} `}> 
